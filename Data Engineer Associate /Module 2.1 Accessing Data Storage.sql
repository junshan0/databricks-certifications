...
select * from csv.`abfss://dbkexternallocation@dbkexternallocation.dfs.core.windows.net/PopulationFolder/`
...
LOCATION 'abfss://dbkexternallocation@dbkexternallocation.dfs.core.windows.net/externaltable1/';

-- Create an external volume in an external location
CREATE EXTERNAL VOLUME external_volume
LOCATION 'abfss://dbkexternallocation@dbkexternallocation.dfs.core.windows.net/externalvolume/'
...
-- Create an external table in an external location
CREATE TABLE external_table_delta
LOCATION 'abfss://dbkexternallocation@dbkexternallocation.dfs.core.windows.net/externaltable2/';
...
LOCATION 'abfss://dbkexternallocation_invalid@dbkexternallocation.dfs.core.windows.net/externaltable2/';
